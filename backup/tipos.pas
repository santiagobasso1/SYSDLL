...
type
 ...
 simbolos=(T_inicio, T_fin, T_pyComa, T_var, T_id, T_opAsig, T_leer, T_parentesisApertura, T_parentesisCierre, T_Cadena, T_coma, T_escribir, T_const, T_menos, T_not, T_or, T_and, T_mayor, {T_menor, T_mayorIgual,}T_OperadorRelacional, {T_menorIgual, T_igual, T_distinto,} T_si, T_entonces,  T_corcheteApertura, T_corcheteCierre, T_sino, T_mientras,T_hacer, T_mas, T_raiz, T_potencia, T_multiplicacion, T_division
